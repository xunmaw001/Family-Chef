  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">家庭大厨微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='dianpu'" class="input-group">
			   <div class="label">店铺账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dianpuzhanghao" class="input" type="text" placeholder="店铺账号">
			   </div>
			 </div> -->
			<el-form-item label="店铺账号" class="input" v-if="tableName=='dianpu'">
			  <el-input v-model="ruleForm.dianpuzhanghao" autocomplete="off" placeholder="店铺账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dianpu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='dianpu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='dianpu'" class="input-group">
			...
			<el-form-item label="店铺名称" class="input" v-if="tableName=='dianpu'">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='dianpu'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='dianpu'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dianpu'" class="input-group">
			   <div class="label">店铺行业</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dianpuxingye" class="input" type="text" placeholder="店铺行业">
			   </div>
			 </div> -->
			<el-form-item label="店铺行业" class="input" v-if="tableName=='dianpu'">
			  <el-input v-model="ruleForm.dianpuxingye" autocomplete="off" placeholder="店铺行业"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dianpu'" class="input-group">
			...
			<el-form-item label="店铺地址" class="input" v-if="tableName=='dianpu'">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210405/a6b1b060587d41b398984c819c57c2a6.jpg");
		height: 100vh;
