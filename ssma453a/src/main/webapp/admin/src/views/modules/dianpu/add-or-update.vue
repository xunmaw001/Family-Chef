<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店铺行业" prop="dianpuxingye">
          <el-input v-model="ruleForm.dianpuxingye" 
              placeholder="店铺行业" clearable  :readonly="ro.dianpuxingye"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店铺行业" prop="dianpuxingye">
              <el-input v-model="ruleForm.dianpuxingye" 
                placeholder="店铺行业" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.dianputupian" label="店铺图片" prop="dianputupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.dianputupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='dianpuxingye'){
            this.ruleForm.dianpuxingye = obj[o];
	    this.ro.dianpuxingye = true;
            continue;
          }
          if(o=='dianputupian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `dianpu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dianpuCrossAddOrUpdateFlag = false;
                  this.parent.search();
