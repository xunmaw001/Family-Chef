    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="菜品特色" prop="caipintese">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.caipintese" label="菜品特色" prop="caipintese">
                    <span v-html="ruleForm.caipintese"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.caipintese = this.ruleForm.caipintese.replace(reg,'../../../ssma453a/upload');
	this.ruleForm.caipinjieshao = this.ruleForm.caipinjieshao.replace(reg,'../../../ssma453a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
