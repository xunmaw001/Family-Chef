<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="菜品评价" prop="caipinpingjia">
          <el-select v-model="ruleForm.caipinpingjia" placeholder="请选择菜品评价">
            <el-option
                v-for="(item,index) in caipinpingjiaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="菜品评价" prop="caipinpingjia">
	      <el-input v-model="ruleForm.caipinpingjia"
                placeholder="菜品评价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="菜品质量" prop="caipinzhiliang">
          <el-select v-model="ruleForm.caipinzhiliang" placeholder="请选择菜品质量">
            <el-option
                v-for="(item,index) in caipinzhiliangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="菜品质量" prop="caipinzhiliang">
	      <el-input v-model="ruleForm.caipinzhiliang"
                placeholder="菜品质量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
	...
	userid : false,
      ...
      ruleForm: {
        ...
        userid: '',
          ...
          caipinpingjiaOptions: [],
          caipinzhiliangOptions: [],
          fuwupingjiaOptions: [],
      rules: {
          dingdanbianhao: [
          ],
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='caipinpingjia'){
            this.ruleForm.caipinpingjia = obj[o];
	    this.ro.caipinpingjia = true;
            continue;
          }
          if(o=='caipinzhiliang'){
            this.ruleForm.caipinzhiliang = obj[o];
	    this.ro.caipinzhiliang = true;
            continue;
          }
          if(o=='fuwupingjia'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.caipinpingjiaOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
            this.caipinzhiliangOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
	...
	this.ruleForm.pingyu = this.ruleForm.pingyu.replace(reg,'../../../ssma453a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
