...
public class DianpuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DianpuEntity user = dianpuService.selectOne(new EntityWrapper<DianpuEntity>().eq("dianpuzhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"dianpu",  "店铺" );
    ...
    public R register(@RequestBody DianpuEntity dianpu){
    	//ValidatorUtils.validateEntity(dianpu);
    	DianpuEntity user = dianpuService.selectOne(new EntityWrapper<DianpuEntity>().eq("dianpuzhanghao", dianpu.getDianpuzhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        DianpuEntity user = dianpuService.selectById(id);
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DianpuEntity dianpu, 
		HttpServletRequest request){
        EntityWrapper<DianpuEntity> ew = new EntityWrapper<DianpuEntity>();
		PageUtils page = dianpuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, dianpu), params), params));
        return R.ok().put("data", page);
